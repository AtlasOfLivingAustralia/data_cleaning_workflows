...
Cautionary note: It is not advised to parallelise downloads from `galah`
...
ALA has added `contentTypes` to further delineate these categories
...
galah_call() |>
  ...
  atlas_counts() -> invert_phyla_counts 
...
### Download data by taxon using `galah`

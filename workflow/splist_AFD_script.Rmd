...
```{r}
worms <- read_csv("data/worms/worms_afd_query_results.csv")
names(worms)
...
worms %>%
  filter(isMarine == 1,
         isBrackish == 0, isTerrestrial == 0, isFreshwater == 0, isExtinct == 0) -> marine_worms # 7024 species
...
nrow(excluded_mar_species) # 6,026 
...
nrow(excluded_mar_species_scientificname) # 643

...
nogriis_afd <- afd_species[! afd_species$VALID_NAME %in% griis_ala_tidy$scientific_name, ]
```
...
My recommendation is to use both lists for now and we can let Doug know that there 
...
# Checking
nrow(nomarine_nogriis_afd_species) + nrow(excluded_mar_species) == nrow(nogriis_afd)
...
nrow(nomarine_nogriis_afd_species_snm) + nrow(excluded_mar_species) + nrow(excluded_mar_species_scientificname) == nrow(nogriis_afd)

...
author: "Fonti Kar, Margot Schneider"
date: "2023-02-20"
...
pacman::p_load(galah, sf, ozmaps, ggforce, ggmap, tidyverse, here, skimr, readr, concaveman, wesanderson, cowplot)
...
main_bbox <- main + 
   geom_rect(aes(xmin = 151.1, xmax = 153.5,
             ymin = -31.5, ymax = -28.5),
             colour = "black",
             linewidth = 0.2, 
             fill = NA)
...
ggdraw(main_bbox) +
  draw_plot(inset, x = .61, y = 0.23, width =0.45, height = 0.4) 
```

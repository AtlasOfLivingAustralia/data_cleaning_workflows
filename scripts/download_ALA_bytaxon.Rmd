...
Some code to deal with mismatched column classes from different phylum, I suspect this might not be an issue if its in one giant tibble in the eventual download, but requires testing and splitting phylums into lists

...
Lets make some alpha shapes for the Powdered Flatwing with increasing values of alpha. We will use the `purrr` R package and a customised function named `extract_polygons` for extracting the polygon outline from an `ashape` object so we can plot it with `ggplot2`.

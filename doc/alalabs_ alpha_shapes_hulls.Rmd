...
Here are some alpha shapes with increasing values for alpha with the `iris` data set.
...
![A Black-Footed Tree Rat perched on a branch](../static/polygons/Mesembriomys_gouldii_1.jpeg){width="7.9cm"}

...
1 Being able to visualise and model where a species resides is an important skill, especially in conservation ecology. Here we'll explain the difference between some commonly used methods for understanding species distributions and show you how to code them yourself! 
